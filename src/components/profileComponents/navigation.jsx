...
export default function Nav({ photo, defaultPhoto }) {
  ...
  return (
    <ul className="side-nav-list">
      <Link to="/home" className="side-nav-links">
        <li>
          <svg
      ...
      <Link to="/search" className="side-nav-links">
        <li>
          <svg
            className="profile-svg"
            viewBox="0 0 24 24"
      ...
      <Link to="/createpost" className="side-nav-links">
        <li>
          <svg
            className="profile-svg"
            viewBox="0 0 24 24"
